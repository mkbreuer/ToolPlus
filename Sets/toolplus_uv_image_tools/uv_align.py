...
#########################################
class AlignRotation(bpy.types.Operator):
...
class EqualizeScale(bpy.types.Operator):
...
# DISTRIBUTION
############################
class DistributeLEdgesH(bpy.types.Operator):
...
class DistributeCentersH(bpy.types.Operator):
...
class DistributeREdgesH(bpy.types.Operator):
...
class DistributeTEdgesV(bpy.types.Operator):
...
class DistributeCentersV(bpy.types.Operator):
...
class DistributeBEdgesV(bpy.types.Operator):
...
class EqualizeHGap(bpy.types.Operator):
...
class EqualizeVGap(bpy.types.Operator):
...
class MatchIsland(bpy.types.Operator):
