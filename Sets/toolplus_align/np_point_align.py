...
class NPPLGetContext(bpy.types.Operator):
    bl_idname = 'object.np_pl_get_context_np'
...
class NPPLGetSelection(bpy.types.Operator):
    bl_idname = 'object.np_pl_get_selection_np'
...
class NPPLGetMouseloc(bpy.types.Operator):
    bl_idname = 'object.np_pl_get_mouseloc_np'
    ...
    def invoke(self,context,event):
        ...
        print('02_GetMouseloc_INVOKED_FINISHED', ';', 'NP020PL.flag = ', NP020PL.flag)
...
class NPPLAddHelper(bpy.types.Operator):
    bl_idname = 'object.np_pl_add_helper_np'
    bl_label = 'NP PL Add Helper'
    bl_options = {'INTERNAL'}

    def execute(self, context):
        print('03_AddHelper_START', ';', 'NP020PL.flag = ', NP020PL.flag)  
        ...
        print('03_AddHelper_FINISHED', ';', 'NP020PL.flag = ', NP020PL.flag)
        return{'FINISHED'}
...
class NPPLPrepareContext(bpy.types.Operator):
    bl_idname = 'object.np_pl_prepare_context_np'
    ...
    def execute(self, context):
        ...
        NP020PL.mode = '1P'
        NP020PL.snap = 'VERTEX'
        print ('prepare, NP020PL.flag = ', flag)
...
class NPPLRunTranslate(bpy.types.Operator):
    bl_idname = 'object.np_pl_run_translate_np'
    bl_label = 'NP PL Run Translate'
    bl_options = {'INTERNAL'}

    print('RunTrans_START',';','NP020PL.flag = ', NP020PL.flag)
    ...
    def modal(self, context, event):
        ...
        if event.type in ('LEFTMOUSE', 'NUMPAD_ENTER', 'SPACE') and event.value == 'RELEASE':
            ...
            if flag == 'RUNTRANSF0':
                ...
                NP020PL.mode = '3P'
                NP020PL.flag = 'ALIGN'
            print('RunTrans_left_enter_FINISHED',';','NP020PL.flag = ', NP020PL.flag)
            return{'FINISHED'}
            ...
            if bpy.context.tool_settings.snap_element == 'VERTEX':
                ...
                bpy.context.tool_settings.snap_element = 'VERTEX'
                NP020PL.snap = 'VERTEX'
            print('RunTrans_enter_PASS')
            return{'FINISHED'}

        elif event.type == 'RIGHTMOUSE':
            bpy.types.SpaceView3D.draw_handler_remove(self._handle, 'WINDOW')
            NP020PL.flag = 'ALIGN'
            print('04_RunTrans_esc_right_FINISHED',';','NP020PL.flag = ', NP020PL.flag)
            return{'FINISHED'}
        ...
        print('04_RunTrans_count_PASS_THROUGH',';','NP020PL.flag = ', NP020PL.flag)
        return{'PASS_THROUGH'}

    def invoke(self, context, event):
        print('RunTrans_INVOKE_START')
        helper = NP020PL.helper
        flag = NP020PL.flag
        ...
        if context.area.type == 'VIEW_3D':
            if flag in ('RUNTRANSF0', 'RUNTRANST0', 'RUNTRANSF1', 'RUNTRANST1', 'RUNTRANSF2', 'RUNTRANST2'):
                ...
                print('RunTrans_INVOKED_RUNNING_MODAL',';','NP020PL.flag = ', NP020PL.flag)
                return {'RUNNING_MODAL'}
            else:
                print('RunTrans_INVOKE_DECLINED_wrong_flag_FINISHED',';','NP020PL.flag = ', NP020PL.flag)
                return {'FINISHED'}
        else:
            self.report({'WARNING'}, "View3D not found, cannot run operator")
            NP020PL.flag = 'EXIT'
            print('RunTrans_INVOKE_DECLINED_no_VIEW_3D_FINISHED',';','NP020PL.flag = ', NP020PL.flag)
            return {'FINISHED'}
...
class NPPLAlignSelected(bpy.types.Operator):
    bl_idname = 'object.np_pl_align_selected_np'
        ...
        if flag == 'ALIGN':
            ...
            if mode in ('2P', '3P'):
                ...
                if mode == '3P':
                    ...
                    print('proj_t, proj_f, tome[1], tome[0]', proj_t, proj_f, tome.vertices[1].co, tome.vertices[0].co)
...
class NPPLRestoreContext(bpy.types.Operator):
    bl_idname = "object.np_pl_restore_context_np"
