...
class NPRMGetContext(bpy.types.Operator):
    bl_idname = 'object.np_rm_get_context_np'
...
class NPRMGetSelection(bpy.types.Operator):
    bl_idname = 'object.np_rm_get_selection_np'
...
class NPRMGetMouseloc(bpy.types.Operator):
    bl_idname = 'object.np_rm_get_mouseloc_np'
    ...
    def modal(self, context, event):
        ...
        print('02_GetMouseloc_FINISHED', ';', 'NP020RM.flag = ', NP020RM.flag)
        return{'FINISHED'}

    def invoke(self,context,event):
        args = (self, context)
        context.window_manager.modal_handler_add(self)
        print('02_GetMouseloc_INVOKED_FINISHED', ';', 'NP020RM.flag = ', NP020RM.flag)
...
class NPRMAddHelper(bpy.types.Operator):
    bl_idname = 'object.np_rm_add_helper_np'
    bl_label = 'NP RM Add Helper'
    bl_options = {'INTERNAL'}

    def execute(self, context):
        print('03_AddHelper_START', ';', 'NP020RM.flag = ', NP020RM.flag)  
        ...
        print('03_AddHelper_FINISHED', ';', 'NP020RM.flag = ', NP020RM.flag)
        return{'FINISHED'}
...
class NPRMPrepareContext(bpy.types.Operator):
    bl_idname = 'object.np_rm_prepare_context_np'
    ...
    def execute(self, context):
        ...
        if flag == 'RUNROTEND':
            ...
            print ('rot_axis, rot_ang =', rot_axis, degrees(rot_ang))
...
class NPRMRunTranslate(bpy.types.Operator):
    bl_idname = 'object.np_rm_run_translate_np'
    bl_label = 'NP RM Run Translate'
    bl_options = {'INTERNAL'}

    if NP020RM.flag == 'RUNTRANSCENTER': print('04_RunTrans_START',';','NP020RM.flag = ', NP020RM.flag)
    elif NP020RM.flag == 'RUNTRANSSTART': print('06_RunTrans_START',';','NP020RM.flag = ', NP020RM.flag)
    count = 0
    ...
    def modal(self, context, event):
        ...
        if self.count == 1:
            if flag == 'RUNTRANSCENTER': print('04_RunTrans_START',';','NP020RM.flag = ', NP020RM.flag)
            elif flag == 'RUNTRANSSTART': print('06_RunTrans_START',';','NP020RM.flag = ', NP020RM.flag)

        if event.type == 'MOUSEMOVE':
            self.co2d = ((event.mouse_region_x, event.mouse_region_y))
            if flag == 'RUNTRANSCENTER': print('04_RunTrans_mousemove',';','NP020RM.flag = ', NP020RM.flag)
            elif flag == 'RUNTRANSSTART': print('06_RunTrans_mousemove',';','NP020RM.flag = ', NP020RM.flag)
            ...
            print('04_RunTrans_left_enter_FINISHED',';','NP020RM.flag = ', NP020RM.flag)
            return{'FINISHED'}

        elif event.type in ('ESC', 'RIGHTMOUSE'):
            bpy.types.SpaceView3D.draw_handler_remove(self._handle, 'WINDOW')
            NP020RM.flag = 'EXIT'
            print('04_RunTrans_esc_right_FINISHED',';','NP020RM.flag = ', NP020RM.flag)
            return{'FINISHED'}

        print('04_RunTrans_count_PASS_THROUGH',';','NP020RM.flag = ', NP020RM.flag)
        return{'PASS_THROUGH'}
    ...
    def invoke(self, context, event):
        ...
        if context.area.type == 'VIEW_3D':
            if flag in ('RUNTRANSCENTER', 'RUNTRANSSTART'):
                ...
                print('04_RunTrans_INVOKED_RUNNING_MODAL',';','NP020RM.flag = ', NP020RM.flag)
                return {'RUNNING_MODAL'}
            else:
                print('04_RunTrans_INVOKE_DECLINED_wrong_flag_FINISHED',';','NP020RM.flag = ', NP020RM.flag)
                return {'FINISHED'}
        else:
            self.report({'WARNING'}, "View3D not found, cannot run operator")
            NP020RM.flag = 'EXIT'
            print('04_RunTrans_INVOKE_DECLINED_no_VIEW_3D_FINISHED',';','NP020RM.flag = ', NP020RM.flag)
            return {'FINISHED'}
...
class NPRMBglPlane(bpy.types.Operator):
    bl_idname = "object.np_rm_bgl_plane_np"
    ...
    def invoke(self, context, event):
        print('05_BglPlane_INVOKE_START')
        flag = NP020RM.flag
        ...
        if flag == 'BGLPLANE':
            ...
            self._handle = bpy.types.SpaceView3D.draw_handler_add(DRAW_Overlay, args, 'WINDOW', 'POST_PIXEL')
            context.window_manager.modal_handler_add(self)
            print('05_BglPlane_INVOKED_RUNNING_MODAL',';','NP020RM.flag = ', NP020RM.flag)
            return {'RUNNING_MODAL'}
        else:
            print('05_BglPlane_INVOKE_DECLINED_wrong_flag_FINISHED',';','NP020RM.flag = ', NP020RM.flag)
            return {'FINISHED'}
...
class NPRMRunRotate(bpy.types.Operator):
    bl_idname = 'object.np_rm_run_rotate_np'
    bl_label = 'NP RM Run Rotate'
    bl_options = {'INTERNAL'}


    print('07_RunRotate_START',';','NP020RM.flag = ', NP020RM.flag)
    ...
    def invoke(self, context, event):
        print('07_RunRotate_INVOKE_START')
        helper = NP020RM.helper
        flag = NP020RM.flag
        selob = NP020RM.selob
        ndef = NP020RM.ndef
...
def DRAW_Overlay(self, context):
    ...
    if flag == 'RUNTRANSCENTER':
        ...
        alpha_real = get_eul_z_angle_difffff_in_rotated_system(rot_helper_0, rot_helper_1, ndef)
...
class NPRMRestoreContext(bpy.types.Operator):
    bl_idname = "object.np_rm_restore_context_np"
