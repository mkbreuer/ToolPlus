...
def construct_roto_widget(alpha_0, alpha_1, fac, r1, r2, angstep):
    ...
    print('ring_sides', ring_sides)
    ring_angstep = alpha / ring_sides
    print ('ring_sides, ring_angstep', ring_sides, ring_angstep)
    ring = []
    ang = alpha_0
...
def get_ro_x_from_iso(region, rv3d, co2d, centerloc):
    ...
    #print ('viso = ', viso)
    #print ( viso[0], viso[1], viso[2])
    #print ('ro_hor = ', ro_hor)
    #print ('ro_hor_deg = ', ro_hor_deg)
...
def get_eul_z_angle_dif_in_rotated_system(eul_0, eul_1, n):
    ...
    if n[2] < 0:
        ...
        print ('n_dif_quat =', n_dif_quat)
        n_dif_eul = n_dif_quat.to_euler()
        print ('n_dif_eul =', n_dif_eul)
...
def get_eul_z_angle_difffff_in_rotated_system(eul_0, eul_1, n):
    ...
    print ('------- eul_0 =', eul_0)
    print ('------- eul_0 =', round(degrees(eul_0.x),2), round(degrees(eul_0.y),2), round(degrees(eul_0.z),2))
    print ('------- eul_1 =', round(degrees(eul_1.x),2), round(degrees(eul_1.y),2), round(degrees(eul_1.z),2))
    v = Vector ((0.0, 0.0, 1.0))
    if n[2] > 0:
        m = copy.deepcopy(n)
    ...
    n_dif_eul = n_dif_quat.to_euler()
    print ('``````` n_dif_eul =', round(degrees(n_dif_eul.x),2), round(degrees(n_dif_eul.y),2), round(degrees(n_dif_eul.z),2))
    a = copy.deepcopy(c)
    b = copy.deepcopy(d)
    a.rotate(n_dif_eul)
    b.rotate(n_dif_eul)
    print ('>>>>>>> eul_0 =', round(degrees(a.x),2), round(degrees(a.y),2), round(degrees(a.z),2))
    print ('>>>>>>> eul_1 =', round(degrees(b.x),2), round(degrees(b.y),2), round(degrees(b.z),2))
    print ('------- eul_1 =', b)
