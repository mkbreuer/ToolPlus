...
def draw_selection_tools_panel_layout(context, layout):
    tp = context.window_manager.scene_window 
    ...
    if context.mode == 'EDIT_MESH':
        ...
        if tp.display_meshlint_toggle:
            row.prop(tp, "display_meshlint_toggle", text="Settings", icon='TRIA_DOWN')
        else:
            row.prop(tp, "display_meshlint_toggle", text="Settings", icon='TRIA_RIGHT')
...
class VIEW3D_TP_Selection_Panel_TOOLS(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        draw_selection_tools_panel_layout(context, layout) 



class VIEW3D_TP_Selection_Panel_UI(bpy.types.Panel):
