...
def load_icons():
    ...
    mkb_icons.load("icon_sphere_blue", os.path.join(icons_dir, "sphere_blue.png"), 'IMAGE')
    mkb_icons.load("icon_sphere_black", os.path.join(icons_dir, "sphere_black.png"), 'IMAGE')
