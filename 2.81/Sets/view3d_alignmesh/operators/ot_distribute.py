...
# operators --------------------------------------------------------------------
class VIEW3D_OT_distribute_vertices(bpy.types.Operator, VertexOperator):
    ''' Distribute vertices evenly along interpolated shape of their polyline '''
    bl_idname = "tpc_ot.vertex_distribute"
...
class VIEW3D_OT_align_vertices(bpy.types.Operator, VertexOperator):
    ''' Project vertices onto the line between the first and last selected vertex '''
    bl_idname = "tpc_ot.vertex_align"
...
class VIEW3D_OT_inline_vertices(bpy.types.Operator, VertexOperator):
    ''' Place vertices evenly along straight line '''
    bl_idname = "tpc_ot.vertex_inline"
