...
class Shrinkwrap(bpy.types.Operator):
    ...
    bl_label = "Shrinkwrap"
    bl_options = {'UNDO'}
    bl_description = "Shrinkwrap the mesh's vertices to the surface constraint's target."
    ...
    def execute(self, context):
        ...
        initially_auto_shrinkwrap_is_enabled = surface_constraint_props.auto_shrinkwrap_is_enabled
        ...
        if surface_constraint_props.auto_shrinkwrap_is_enabled == False:
            apply_shrinkwrap(
