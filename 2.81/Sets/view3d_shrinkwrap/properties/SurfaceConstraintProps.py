...
class SurfaceConstraintProps(bpy.types.PropertyGroup):
    ...
    def update_auto_shrinkwrap(self, context):
        ...
        # Automatic shrinkwrapping has been disabled.
            ...
            while i:
                i -= 1
                if (scene_update_pre[i] == auto_shrinkwrap_handlers.scene_update_pre):
                    scene_update_pre[-1], scene_update_pre[i] = (scene_update_pre[i], scene_update_pre[-1])
    ...
    direction : bpy.props.EnumProperty(
        ...
        description = ("Shrinkwrap along vertex normals or towards the closest points on the target object."),
    ...
    wrap_method_map = {'CLOSEST_POINT'  : 'NEAREST_SURFACEPOINT', 
                       'ALONG_AXIS'     : 'PROJECT',
                       'NEAREST_VERTEX' : 'NEAREST_VERTEX',
                       'VERTEX_NORMAL'  : 'TARGET_PROJECT'}
