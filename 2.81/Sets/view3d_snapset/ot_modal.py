...
class VIEW3D_OT_snapset_modal(bpy.types.Operator):
        ...
        def invoke(self, context, event):  
            ...
            if bpy.context.active_object is not None:
                ...
                # change settings: snap active to perpendicular edges              
                ...
                # change settings: snap active to center edges                    
                if "PERPENDICULAR" in self.mode:  
                    bpy.context.scene.tool_settings.transform_pivot_point = 'ACTIVE_ELEMENT'
                ...
                self.report({'WARNING'}, "Need Active in 3D View")  
                return {'CANCELLED'}
