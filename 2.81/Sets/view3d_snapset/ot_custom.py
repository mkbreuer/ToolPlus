...
class VIEW3D_OT_snapset_button_G(bpy.types.Operator):
    ...
    def execute(self, context):            
        ...
        bpy.context.scene.tool_settings.transform_pivot_point = addon_prefs.prop_btg_pivot     
        bpy.context.scene.tool_settings.use_transform_pivot_point_align = addon_prefs.prop_btg_use_pivot 
        bpy.context.scene.tool_settings.snap_elements = {addon_prefs.prop_btg_elements}
        bpy.context.scene.tool_settings.snap_target = addon_prefs.prop_btg_target
        bpy.context.scene.tool_settings.use_snap_grid_absolute = addon_prefs.prop_btg_absolute_grid               
        bpy.context.scene.tool_settings.use_snap_self = addon_prefs.prop_btg_snap_self
        bpy.context.scene.tool_settings.use_snap_align_rotation = addon_prefs.prop_btg_align_rotation       
        bpy.context.scene.tool_settings.use_snap_project = addon_prefs.prop_btg_project
        bpy.context.scene.tool_settings.use_snap_peel_object = addon_prefs.prop_btg_peel_object
        bpy.context.scene.tool_settings.use_snap_translate = addon_prefs.prop_btg_translate
        bpy.context.scene.tool_settings.use_snap_rotate = addon_prefs.prop_btg_rotation
        bpy.context.scene.tool_settings.use_snap_scale = addon_prefs.prop_btg_scale
...
class VIEW3D_OT_snapset_button_H(bpy.types.Operator):
    ...
    def execute(self, context):            
        ...
        bpy.context.scene.tool_settings.transform_pivot_point = addon_prefs.prop_bth_pivot     
        bpy.context.scene.tool_settings.use_transform_pivot_point_align = addon_prefs.prop_bth_use_pivot 
        bpy.context.scene.tool_settings.snap_elements = {addon_prefs.prop_bth_elements}
        bpy.context.scene.tool_settings.snap_target = addon_prefs.prop_bth_target
        bpy.context.scene.tool_settings.use_snap_grid_absolute = addon_prefs.prop_bth_absolute_grid               
        bpy.context.scene.tool_settings.use_snap_self = addon_prefs.prop_bth_snap_self
        bpy.context.scene.tool_settings.use_snap_align_rotation = addon_prefs.prop_bth_align_rotation       
        bpy.context.scene.tool_settings.use_snap_project = addon_prefs.prop_bth_project
        bpy.context.scene.tool_settings.use_snap_peel_object = addon_prefs.prop_bth_peel_object
        bpy.context.scene.tool_settings.use_snap_translate = addon_prefs.prop_bth_translate
        bpy.context.scene.tool_settings.use_snap_rotate = addon_prefs.prop_bth_rotation
        bpy.context.scene.tool_settings.use_snap_scale = addon_prefs.prop_bth_scale
