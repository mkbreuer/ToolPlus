    ...
    def draw(self, context):
        ...
        if ob.mode == 'OBJECT':
            ...
            if len(bpy.context.selected_objects) == 1: 
                ...
                button_origin_bbox = icons.get("icon_origin_bbox")                               
                layout.operator("tp_ops.bbox_origin_modal_ops", text="1-BBox Modal", icon_value=button_origin_bbox.icon_id)                                
...
class VIEW3D_TP_Origin_Menu_Align(bpy.types.Menu):
    bl_label = "Origin"
    bl_idname = "VIEW3D_TP_Origin_Menu_Align"   
