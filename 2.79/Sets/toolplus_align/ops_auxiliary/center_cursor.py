...
#based on TinyCAD:  zeffii (aka Dealga McArdle)
...
class CircleCenterCursor(bpy.types.Operator):
    """center cursor to a circle middle / need three selected vertices"""
    bl_idname = 'mesh.circlecentercursor'
    bl_label = 'cursor circle center'
