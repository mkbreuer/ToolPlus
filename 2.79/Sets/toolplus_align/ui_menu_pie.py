...
########### 1_Left ------------------------------------------------ 
        ...
        if context.mode =="OBJECT":
            ...
            row.operator("object.distribute_osc", text=" ", icon_value=button_origin_align.icon_id)    
...
########### 3_Bottom ------------------------------------------------   
        ...
        if context.mode =="OBJECT":
            ...
            if bpy.context.mode == "EDIT_MESH":
                ...
                row.operator("mesh.wplsmthdef_apply", text=" ", icon ="FRAME_NEXT")                
                row.operator("transform.vert_slide",text=" ", icon ="PAUSE")     
