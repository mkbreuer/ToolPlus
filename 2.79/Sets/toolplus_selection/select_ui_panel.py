...
class draw_panel_layout_select:
    ...
    def draw(self, context):
        ...
        if context.mode == 'EDIT_TEXT':
            ...
            row = box.row(1)          
            row.operator("font.select_all", text="Select All", icon="RESTRICT_SELECT_OFF")  
            ...
            if context.mode == 'EDIT_MESH':
                ...
                if TP_MeshLintVitalizer.is_live:
                    ...
                    live_label = 'Live!'
                    play_pause = 'TRIA_RIGHT'
                
                row.operator('tp_meshlint.live_toggle', text="", icon=play_pause) 
                row.operator('tp_meshlint.live_toggle', text=live_label, icon='BLANK1') 

                row.operator('tp_meshlint.select', text='MeshLint', icon='BLANK1')            
                row.operator('tp_meshlint.select', text='', icon='EDIT')       
                ...
                if tp_props.display_check_toggle:
                    ...
                    row.prop(tp_props, "display_check_toggle", text="", icon='TRIA_RIGHT')
                    row.prop(tp_props, "display_check_toggle", text="Output", icon='BLANK1')
                ...
                if tp_props.display_meshlint_toggle:
                    ...
                    row.prop(tp_props, "display_meshlint_toggle", text="Settings", icon='BLANK1')
                    row.prop(tp_props, "display_meshlint_toggle", text="", icon='TRIA_LEFT')            
                ...
                row = box.row(1)
                row.operator_menu_enum("mesh.sort_elements", "type", text="Sort Elements...")
