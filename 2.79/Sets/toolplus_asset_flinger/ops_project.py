...
class ScreenRenderer:
    ...
    def draw(self, width, height):
        ...
        if not self._items:
            ...
            self._nfo = "No items in asset folder, verify path (%s)." % preferences().custom_library_path_project
        else:
            # Render item by item.
...
class AssetFlingerMenu(Operator):
    ...
    """
    bl_idname = "view3d.asset_flinger_project"
    ...
    def invoke(self, context, event):
        ...
        if context.area.type == 'VIEW_3D':
            ...
            assets = preferences().custom_library_path_project
...
class AssetFlingerExport(Operator, ExportHelper):
    ...
    """
    bl_idname = "export.asset_flinger_project"
