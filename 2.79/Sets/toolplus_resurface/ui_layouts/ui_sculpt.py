...
def draw_sculpt_ui(self, context, layout):
        ...
        row = box.row(1)     
        button_draw_surface = icons.get("icon_draw_surface")     
        row.operator("tp_ops.curve_draw", text="Surface", icon_value=button_draw_surface.icon_id).mode ='surface'        
  
        button_draw_lathe = icons.get("icon_draw_lathe")     
        row.operator("tp_ops.curve_lathe", text="Lathe", icon_value=button_draw_lathe.icon_id)    
