...
def draw_pencil_ui(self, context, layout):
        ...
        if not tp_props.display_pencil_edm:               
            ...
            row.operator("gpencil.draw", text="", icon_value=button_draw_pencil.icon_id).mode = 'DRAW'
            ...
            button_draw_pencil_surface = icons.get("icon_draw_pencil_surface")
            row.operator("tp_ops.surface_pencil", text="",icon="GREASEPENCIL")                  
            ...
            row = box.row(1)
            row.operator("tp_ops.surface_pencil", text="Hand",icon="GREASEPENCIL")               
