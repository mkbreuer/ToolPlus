...
def create_spline_curve(self, context, verts, lh, rh, dim_type, spline_type, handle_type):

    in_scale_x = self.in_scale_x
    in_scale_y = self.in_scale_y

    out_scale_x = self.out_scale_x
    out_scale_y = self.out_scale_y
    ...
    curve_data = bpy.data.curves.new(name=target.name +'_Bevel', type='CURVE')
    curve_data.dimensions = dim_type
...
def add_type_3chamfer(self, context):    
    ...
    verts = [[-0.061603 * in_scale_x,  -0.05      * in_scale_y,  0.0,  
              -0.074103 * out_scale_x, -0.028349  * out_scale_y, 0.0,   
              -0.0125   * in_scale_x,   0.078349  * in_scale_y,  0.0,    
               0.0125   * in_scale_x,   0.078349  * in_scale_y,  0.0,
               0.074103 * out_scale_x, -0.028349  * out_scale_y, 0.0,   
               0.061603 * in_scale_x,  -0.05      * in_scale_y,  0.0]]

    lhandles = [[(-0.05     * in_scale_x,  -0.027606 * in_scale_y,  0.0), 
                 (-0.027606 * out_scale_x,  0.05     * out_scale_y, 0.0), 
                 ( 0.05     * in_scale_x,   0.027606 * in_scale_y,  0.0), 
                 ( 0.027606 * out_scale_x, -0.05     * out_scale_y, 0.0),
                 (-0.05     * in_scale_x,  -0.027606 * in_scale_y,  0.0), 
                 (-0.027606 * out_scale_x,  0.05     * out_scale_y, 0.0), 
                 ( 0.05     * in_scale_x,   0.027606 * in_scale_y,  0.0), 
    ...
    rhandles = [[(-0.05     * in_scale_x,   0.027607 * in_scale_y,  0.0), 
                 ( 0.027607 * out_scale_x,  0.005    * out_scale_y, 0.0),
                 ( 0.05     * in_scale_x,  -0.027607 * in_scale_y,  0.0), 
                 (-0.027607 * out_scale_x, -0.05     * out_scale_y, 0.0),
                 (-0.05     * in_scale_x,   0.027607 * in_scale_y,  0.0), 
                 ( 0.027607 * out_scale_x,  0.005    * out_scale_y, 0.0), 
                 ( 0.05     * in_scale_x,  -0.027607 * in_scale_y,  0.0), 
                 (-0.027607 * out_scale_x, -0.05     * out_scale_y, 0.0)]]

    create_spline_curve(self, context, verts, lhandles, rhandles, self.dim_type, self.spline_type, self.handle_type)
...
def add_type_4chamfer(self, context):
    ...
    verts = [[-0.017678 * in_scale_x,  -0.082322 * in_scale_y,  0.0,   
              -0.082322 * out_scale_x, -0.017678 * out_scale_y,  0.0,  
              -0.082322 * out_scale_x,  0.017678 * out_scale_y, 0.0,   
              -0.017678 * in_scale_x,   0.082322 * in_scale_y, 0.0,
               0.017678 * in_scale_x,   0.082322 * in_scale_y,  0.0,    
               0.082322 * out_scale_x,  0.017678 * out_scale_y,  0.0,   
               0.082322 * out_scale_x, -0.017678 * out_scale_y, 0.0,    
               0.017678 * in_scale_x,  -0.082322 * in_scale_y, 0.0,]]
...
def add_type_4chamfer_B(self, context):
    ...
    verts = [[-0.017678 * in_scale_x,  -0.082322 * in_scale_y,  0.0,   
              -0.082322 * in_scale_x,  -0.017678 * in_scale_y,  0.0,  
              -0.082322 * out_scale_x,  0.017678 * out_scale_y, 0.0,   
              -0.017678 * out_scale_x,  0.082322 * out_scale_y, 0.0,
               0.017678 * in_scale_x,   0.082322 * in_scale_y,  0.0,    
               0.082322 * in_scale_x,   0.017678 * in_scale_y,  0.0,   
               0.082322 * out_scale_x, -0.017678 * out_scale_y, 0.0,    
               0.017678 * out_scale_x, -0.082322 * out_scale_y, 0.0,]]
...
def add_type_5chamfer(self, context):
    ...
    verts = [[-0.033779 * in_scale_x,  -0.080902  * in_scale_y,  0.0,   
              -0.066504 * out_scale_x, -0.057125  * out_scale_y, 0.0,   
              -0.08738  * out_scale_x,  0.0071253 * out_scale_y, 0.0,   
              -0.07488  * in_scale_x,   0.045596  * in_scale_y,  0.0,
              -0.020225 * out_scale_x,  0.085305  * out_scale_y, 0.0,    
               0.020225 * out_scale_x,  0.085305  * out_scale_y, 0.0,    
               0.07488  * in_scale_x,   0.045596  * in_scale_y,  0.0,    
               0.08738  * out_scale_x,  0.0071253 * out_scale_y, 0.0,
               0.066504 * out_scale_x, -0.057125  * out_scale_y, 0.0,    
               0.033779 * in_scale_x,  -0.080902  * in_scale_y,  0.0]]
...
def add_type_3star(self, context):    
    ...
    verts = [[ 0.0      * out_scale_x, -0.025  * out_scale_y, 0.0,  
              -0.086603 * in_scale_x,  -0.05   * in_scale_y,  0.0,   
              -0.024651 * out_scale_x,  0.0125 * out_scale_y, 0.0,   
               0.0      * in_scale_x,   0.1    * in_scale_y,  0.0,
               0.021651 * out_scale_x,  0.0125 * out_scale_y, 0.0,   
               0.086603 * in_scale_x,  -0.05   * in_scale_y,  0.0]]

    lhandles = [[(-0.05     * out_scale_x, -0.027606 * out_scale_y, 0.0), 
                 (-0.027606 * in_scale_x,   0.05     * in_scale_y,  0.0), 
                 ( 0.05     * out_scale_x,  0.027606 * out_scale_y, 0.0), 
                 ( 0.027606 * in_scale_x,  -0.05     * in_scale_y,  0.0),
                 (-0.05     * out_scale_x, -0.027606 * out_scale_y, 0.0), 
                 (-0.027606 * in_scale_x,   0.05     * in_scale_y,  0.0)]]

    rhandles = [[(-0.05     * out_scale_x,  0.027607 * out_scale_y, 0.0), 
                 ( 0.027607 * in_scale_x,   0.005    * in_scale_y,  0.0), 
                 ( 0.05     * out_scale_x, -0.027607 * out_scale_y, 0.0), 
                 (-0.027607 * in_scale_x,  -0.05     * in_scale_y,  0.0),
                 (-0.05     * out_scale_x,  0.027607 * out_scale_y, 0.0), 
                 ( 0.027607 * in_scale_x,   0.005    * in_scale_y,  0.0)]]
...
def add_type_4star(self, context):
    ...
    verts = [[0.0   * out_scale_x, -0.1   * out_scale_y, 0.0,   
             -0.025 * in_scale_x,  -0.025 * in_scale_y,  0.0,  
             -0.1   * out_scale_x,  0.0   * out_scale_y, 0.0,   
             -0.025 * in_scale_x,   0.025 * in_scale_y,  0.0,
              0.0   * out_scale_x,  0.1   * out_scale_y, 0.0,    
              0.025 * in_scale_x,   0.025 * in_scale_y,  0.0,   
              0.1   * out_scale_x,  0.0   * out_scale_y, 0.0,    
              0.025 * in_scale_x,  -0.025 * in_scale_y,  0.0]] 
...
def add_type_5star(self, context):    
    ...
    verts = [[-0.0      * in_scale_x,  -0.044314 * in_scale_y,  0.0,   
              -0.058779 * out_scale_x, -0.080902 * out_scale_y, 0.0,   
              -0.038471 * in_scale_x,  -0.016363 * in_scale_y,  0.0,    
              -0.095106 * out_scale_x,  0.030902 * out_scale_y, 0.0,
              -0.023776 * in_scale_x,   0.028863 * in_scale_y,  0.0,   
               0.0      * out_scale_x,  0.1      * out_scale_y, 0.0,   
               0.023776 * in_scale_x,   0.028863 * in_scale_y,  0.0,    
               0.095106 * out_scale_x,  0.030902 * out_scale_y, 0.0,          
               0.038471 * in_scale_x,  -0.016363 * in_scale_y,  0.0,    
...
def add_type_6star(self, context):    
    ...
    verts = [[ 0.0      * out_scale_x, -0.1    * out_scale_y, 0.0,   
              -0.021651 * in_scale_x,  -0.0375 * in_scale_y,  0.0,   
              -0.086603 * out_scale_x, -0.05   * out_scale_y, 0.0,   
              -0.043301 * in_scale_x,   0.0    * in_scale_y,  0.0,
              -0.086603 * out_scale_x,  0.05   * out_scale_y, 0.0,   
              -0.021651 * in_scale_x,   0.0375 * in_scale_y,  0.0,   
               0.00     * out_scale_x,  0.1    * out_scale_y, 0.0,   
               0.021651 * in_scale_x,   0.0375 * in_scale_y,  0.0,
               0.086603 * out_scale_x,  0.05   * out_scale_y, 0.0,    
               0.043301 * in_scale_x,   0.0    * in_scale_y,  0.0,    
               0.086603 * out_scale_x, -0.05   * out_scale_y, 0.0,    
...
def add_type_8star(self, context):
    ...
    verts = [[ 0.0      * out_scale_x, -0.1      * out_scale_y, 0.0,   
              -0.017678 * in_scale_x,  -0.042678 * in_scale_y,  0.0,   
              -0.070711 * out_scale_x, -0.070711 * out_scale_y, 0.0,   
              -0.042678 * in_scale_x,  -0.017678 * in_scale_y,  0.0,       
              -0.1      * out_scale_x,  0.0      * out_scale_y, 0.0,   
              -0.042678 * in_scale_x,   0.017678 * in_scale_y,  0.0,   
              -0.070711 * out_scale_x,  0.070711 * out_scale_y, 0.0,   
              -0.017678 * in_scale_x,   0.042678 * in_scale_y,  0.0,
...
class VIEW3D_TP_Add_Bevel_Guide(Operator, AddObjectHelper):
    """Add a bevel curve guide to a active curve"""
    bl_idname = "tp_ops.add_bevel_guide"
...
#    bpy.types.Scene.tp_bool = bpy.props.EnumProperty(name = " ", default = "tp_01", items = types_bool)
    ...
    dim_type = EnumProperty(name = "Dim Type",
            items=(('2D',  "2D",   ""),                                                    
                   ('3D',  "3D",   "")),                   
                   default='3D',
                   description="change dimension type of curve")

    spline_type = EnumProperty(name = "Spline Type",
            items=(('POLY',    "Poly",     ""),                   
                   ('NURBS',   "Nurbs",    ""),                                    
                   ('BEZIER',  "Bezier",   "")),                   
                   default='BEZIER',
                   description="change spline type of curve")
 
    handle_type = EnumProperty(name = "Handle Type",
            items=(('FREE',   "Free",    ""),                                                    
                   ('VECTOR', "Vector",  ""),                   
                   ('ALIGNED',  "Align",   ""),                   
                   ('AUTO',   "Auto",    "")),                   
    ...
    fill_type = IntProperty(name="Fill Type", default=3, min=1, max=3, description="fill type of bevel")
    ...
    in_scale_x = FloatProperty(name="in_x", description="scale on x axis", default=5.0)
    in_scale_y = FloatProperty(name="in_y", description="scale on y axis", default=5.0)

    out_scale_x = FloatProperty(name="out_x", description="scale on x axis", default=5.0)
    out_scale_y = FloatProperty(name="out_y", description="scale on y axis", default=5.0)

    link = BoolProperty(name='link xy', default=True)

    link_xy_in = BoolProperty(name='link xy', default=True)
    link_xy_out = BoolProperty(name='link xy', default=True)

    transform = bpy.props.BoolProperty(name='Transform', default=False)
    ...
    def draw(self, context):
        ...
        row.prop(self, 'shape_type', text="")
      
        box.separator()        
     
        row = box.row(1)
        row.label("Dim Type:")         
        row.prop(self, 'dim_type', text="")          
       
        box.separator()        
       
        row = box.row(1)
        row.label("Spline Type:")           
        row.prop(self, 'spline_type', text="")          
       
        box.separator()     
       
        row = box.row(1)
        row.label("Handle Type:")      
        row.prop(self, 'handle_type', text="")      

        box.separator()
      
        row = box.row(1)                 
        row.prop(self, "transform")      
        ...
        row = box.row(1)  
        row.prop(self, "link_xy_in", toggle=True, text="", icon="LINKED")         
        row.prop(self, "in_scale_x")   
        row.prop(self, "in_scale_y")   
      
        row = box.row(1)          
        row.prop(self, "link_xy_out", toggle=True, text="", icon="LINKED")  
        row.prop(self, "out_scale_x")
        row.prop(self, "out_scale_y")
    ...
    def execute(self, context):
        ...
        if self.link_xy_in:
            self.in_scale_y  = self.in_scale_x

        if self.link_xy_out:
            self.out_scale_y = self.out_scale_x
...
def register():
    ...
    bpy.utils.register_class(VIEW3D_TP_Add_Bevel_Guide)

def unregister():
    bpy.utils.unregister_class(add_tapercurve)
    bpy.utils.unregister_class(VIEW3D_TP_Add_Bevel_Guide)
