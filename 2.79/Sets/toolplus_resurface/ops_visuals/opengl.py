...
class VIEW3D_TP_Visual_OpenGLLightsProperties(bpy.types.PropertyGroup):
    @classmethod
    def register(cls):
...
class VIEW3D_TP_Visual_opengl_lights_preset_add(AddPresetBase, bpy.types.Operator):
    """Add & Remove Preset"""
...
class VIEW3D_TP_Visual_opengl_lights_presets(bpy.types.Menu):
