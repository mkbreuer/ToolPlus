...
def draw_menu_origin_layout(self, context, layout):
...
def draw_menu_origin_mainlayout(self, context, layout):
        ...
        if ob.mode == 'OBJECT':
            ...
            layout.operator("tp_ops.origin_to_selected", text="Origin to Selected", icon = "BORDER_RECT")
            ...
            layout.operator("tp_ops.copy_origin", text="Copy Active Origin", icon_value=button_origin_copy.icon_id)
        ...
        if ob.mode == 'EDIT_MESH':
            ...
            draw_menu_origin_layout(self, context, layout) 
...
class VIEW3D_TP_Origin_Menu(bpy.types.Menu):
    bl_label = "Origin"
    bl_idname = "tp_menu.menu_origin"   

    def draw(self, context):
        layout = self.layout

        draw_menu_origin_mainlayout(self, context, layout) 



class VIEW3D_TP_Origin_Panel_Menu(bpy.types.Menu):
    bl_label = "Origin"
    bl_idname = "tp_menu.pl_menu_origin"   
