...
#                    draw_pencil_ui(self, context, layout) 
        ...
        if display_history == 'on':
            ...
            if tp_props.display_docu:
                row.prop(tp_props, "display_docu", text="", icon='PROP_CON')
            else:
                row.prop(tp_props, "display_docu", text="", icon='PROP_CON')     
            ...
            if tp_props.display_docu:                
                ...
                row.prop(panel_prefs, 'tab_add_ui', expand=True)                                       
                row.prop(panel_prefs, 'tab_title_ui', expand=True)                                       
                row.prop(panel_prefs, 'tab_pivot_ui', expand=True)                                       
                row.prop(panel_prefs, 'tab_create_ui', expand=True)                                       
                row.prop(panel_prefs, 'tab_origin_ui', expand=True)                                       
                row.prop(panel_prefs, 'tab_surface_ui', expand=True)
                row.prop(panel_prefs, 'tab_snapshot_ui', expand=True)
                row.prop(panel_prefs, 'tab_boolean_ui', expand=True)
                row.prop(panel_prefs, 'tab_align_ui', expand=True)
                row.prop(panel_prefs, 'tab_symdim_ui', expand=True)
                row.prop(panel_prefs, 'tab_copy_ui', expand=True)
                row.prop(panel_prefs, 'tab_edit_ui', expand=True)
                row.prop(panel_prefs, 'tab_mirastretch_ui', expand=True)
                row.prop(panel_prefs, 'tab_miraguide_ui', expand=True)                        
                row.prop(panel_prefs, 'tab_pencil_ui', expand=True)
                row.prop(panel_prefs, 'tab_spacing_ui', expand=True)
                row.prop(panel_prefs, 'tab_relax_ui', expand=True)
                row.prop(panel_prefs, 'tab_check_ui', expand=True)     
                row.prop(panel_prefs, 'tab_mirawrap_ui', expand=True)           
                row.prop(panel_prefs, 'tab_recoplanar_ui', expand=True)          
                row.prop(panel_prefs, 'tab_transform_ui', expand=True)          
                row.prop(panel_prefs, 'tab_convert_ui', expand=True)
                row.prop(panel_prefs, 'tab_miratools_ui', expand=True)
                row.prop(panel_prefs, 'tab_modifier_ui', expand=True)
                row.prop(panel_prefs, 'tab_biped_ui', expand=True)     
                row.prop(panel_prefs, 'tab_visual_ui', expand=True)          
                row.prop(panel_prefs, 'tab_history_ui', expand=True) 
                row.prop(panel_prefs, 'tab_custom_ui', expand=True)
