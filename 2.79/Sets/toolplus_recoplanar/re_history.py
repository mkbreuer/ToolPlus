    ...
    if tp_props.display_options: 
        ...
        if display_icon_type == 'icons':
            ...
            if tp_props.display_options_panel:               
                ...
                row.prop(panel_prefs, 'tab_automirror', text="AutoMirror")
                row.prop(panel_prefs, 'tab_mirror_cut', text="AutoCut")
                ...
                row.prop(panel_prefs, 'tab_toall', text="CopyTo")
        ...
        if tp_props.display_options_menu:  
            ...
            row.prop(panel_prefs, 'tab_automirror_menu', text="AutoSym")                
