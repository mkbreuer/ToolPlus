...
class VIEW3D_OT_Snapset_Button_A(bpy.types.Operator):
    ...
    def execute(self, context):            
        ...
        bpy.context.space_data.pivot_point = addon_prefs.prop_bta_pivot     
        bpy.context.space_data.use_pivot_point_align = addon_prefs.prop_bta_use_pivot 
        bpy.context.scene.tool_settings.snap_element = addon_prefs.prop_bta_elements
...
class VIEW3D_OT_Snapset_Button_B(bpy.types.Operator):
    ...
    def execute(self, context):            
        ...
        bpy.context.space_data.pivot_point = addon_prefs.prop_btb_pivot     
        bpy.context.space_data.use_pivot_point_align = addon_prefs.prop_btb_use_pivot 
        bpy.context.scene.tool_settings.snap_element = addon_prefs.prop_btb_elements
...
class VIEW3D_OT_Snapset_Button_C(bpy.types.Operator):
    ...
    def execute(self, context):            
        ...
        bpy.context.space_data.pivot_point = addon_prefs.prop_btc_pivot     
        bpy.context.space_data.use_pivot_point_align = addon_prefs.prop_btc_use_pivot 
        bpy.context.scene.tool_settings.snap_element = addon_prefs.prop_btc_elements
...
class VIEW3D_OT_Snapset_Button_D(bpy.types.Operator):
    ...
    def execute(self, context):            
        ...
        bpy.context.space_data.pivot_point = addon_prefs.prop_btd_pivot     
        bpy.context.space_data.use_pivot_point_align = addon_prefs.prop_btd_use_pivot 
        bpy.context.scene.tool_settings.snap_element = addon_prefs.prop_btd_elements
...
class VIEW3D_OT_Snapset_Button_E(bpy.types.Operator):
    ...
    def execute(self, context):            
        ...
        bpy.context.space_data.pivot_point = addon_prefs.prop_bte_pivot     
        bpy.context.space_data.use_pivot_point_align = addon_prefs.prop_bte_use_pivot 
        bpy.context.scene.tool_settings.snap_element = addon_prefs.prop_bte_elements
...
class VIEW3D_OT_Snapset_Button_F(bpy.types.Operator):
    ...
    def execute(self, context):            
        ...
        bpy.context.space_data.pivot_point = addon_prefs.prop_btf_pivot     
        bpy.context.space_data.use_pivot_point_align = addon_prefs.prop_btf_use_pivot 
        bpy.context.scene.tool_settings.snap_element = addon_prefs.prop_btf_elements
