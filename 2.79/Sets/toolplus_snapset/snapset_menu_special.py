...
# UI: SUB MENU SPECIAL # 
class VIEW3D_TP_SnapSet_Menu_Special(bpy.types.Menu):
    bl_label = "SnapSet"
    bl_idname = "tp_menu.menu_snapset_special"
...
def draw_snapset_item_special(self, context):
    ...
    layout.menu("tp_menu.menu_snapset_special", text="SnapSet", icon_value=button_snap_set.icon_id)      
