...
def draw_origin_menu_layout_special(self, context, layout):
...
# UI: HOTKEY MENU # 
class VIEW3D_MT_Origin_Menu_Special(bpy.types.Menu):
    bl_label = "Set Origin"
    bl_idname = "VIEW3D_MT_Origin_Menu_Special"
    ...
    def draw(self, context):
        ...
        if context.mode == 'EDIT_MESH':
            draw_origin_menu_layout_special(self, context, layout) 
