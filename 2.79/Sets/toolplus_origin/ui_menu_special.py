...
def draw_originset_menu_layout_special(self, context, layout):
...
def draw_origin_item_special(self, context):
    ...
    if addon_prefs.toggle_special_origin_menu_type == True:        
        if addon_prefs.toggle_special_origin_icon == True:
            button_origin_center_view = icons.get("icon_origin_center_view")
            layout.menu("VIEW3D_MT_OriginSet_Menu_Special", text="OriginSet", icon_value=button_origin_center_view.icon_id)      
        else:
            layout.menu("VIEW3D_MT_OriginSet_Menu_Special", text="OriginSet")      
    else:
        if addon_prefs.toggle_special_origin_icon == True:
            button_origin_center_view = icons.get("icon_origin_center_view")
            layout.menu("VIEW3D_MT_OriginSet_Menu", text="OriginSet", icon_value=button_origin_center_view.icon_id)      
        else:
            layout.menu("VIEW3D_MT_OriginSet_Menu", text="OriginSet")      
