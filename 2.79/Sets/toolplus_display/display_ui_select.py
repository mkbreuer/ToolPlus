...
class VIEW3D_TP_Select_Panel_TOOLS(bpy.types.Panel, draw_layout_select):
    bl_category = "T+"
    bl_idname = "VIEW3D_TP_Select_Panel_TOOLS"
    bl_label = "Select"
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'TOOLS'
    bl_options = {'DEFAULT_CLOSED'}

class VIEW3D_TP_Select_Panel_UI(bpy.types.Panel, draw_layout_select):
    bl_idname = "VIEW3D_TP_Select_Panel_UI"
    bl_label = "Select"
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_options = {'DEFAULT_CLOSED'}
