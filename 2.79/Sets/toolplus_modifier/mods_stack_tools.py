...
class VIEW3D_TP_Modifier_Stack_Panel_TOOLS(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        if mod_list:
            ...
            Display_Stack_Remove = context.user_preferences.addons[__package__].preferences.tab_stack_remove
            Display_Stack_Copy = context.user_preferences.addons[__package__].preferences.tab_stack_copy
