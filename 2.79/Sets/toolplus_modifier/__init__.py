...
if "bpy" in locals():
    ...
    from .operators import mods_cut_auto                                              
    from .operators import mods_display                       
    from .operators import mods_mirror         
    from .operators import mods_mirror_auto                
...
class TP_Panels_Preferences(AddonPreferences):
    ...
    tab_automirror = bpy.props.BoolProperty(name="AutoSym", description="on/off", default=True)  
    ...
    tab_displace = bpy.props.BoolProperty(name="Displace", description="on/off", default=True)  
    ...
    tab_toall = bpy.props.BoolProperty(name="Copy 2-All", description="on/off", default=True)  
    ...
    tab_stack_copy = bpy.props.BoolProperty(name="Copy 2-All", description="on/off", default=True)  
    tab_stack_remove = bpy.props.BoolProperty(name="Remove Type", description="on/off", default=True)  
    ...
    tab_automirror_menu = bpy.props.BoolProperty(name="AutoMirror", description="on/off", default=True)  
    ...
    tab_hover_menu = bpy.props.BoolProperty(name="HoverTools", description="on/off", default=True)  
...
class Dropdown_TP_Modifier_Props(bpy.types.PropertyGroup):
    ...
    display_vertgrp = bpy.props.BoolProperty(name="Open / Close", description="Open / Close", default=True) 
    ...
    display_sculpt_displace = bpy.props.BoolProperty(name="Open / Close", description="Open / Close", default=True)  
