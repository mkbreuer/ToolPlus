...
def update_menu_modifier(self, context):
    try:
    ...
    if context.user_preferences.addons[__package__].preferences.tab_menu_modifier == 'menu':
        ...
        kmi = km.keymap_items.new('wm.call_menu', 'V', 'PRESS', shift=True) #add here your new key event
    ...
    if context.user_preferences.addons[__package__].preferences.tab_menu_modifier == 'off':
        pass
