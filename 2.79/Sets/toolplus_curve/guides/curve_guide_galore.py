...
# t+ version: adjusted to use direct as bevel guide
...
def createCurve(context, vertArray, self, align_matrix):
    ...
    # create curve with name from active and extension
    scene = context.scene
    newCurve = bpy.data.curves.new(name=target.name +'_Bevel', type='CURVE')
    ...
    # add new curve as bevel guide to active #     
...
class VIEW3D_TP_Curveaceous_Galore(bpy.types.Operator):
    """Add many types of curves"""
    bl_idname = "tp_ops.curves_galore"
    ...
    Profile_Var_link = BoolProperty(name='link var', default=False)
    Misc_Var_link = BoolProperty(name='link var', default=False)
    Flower_Radius_link = BoolProperty(name='link var', default=False)
    Star_Radius_link = BoolProperty(name='link var', default=False)
    Arc_Radius_link = BoolProperty(name='link var', default=False)
    Cogwheel_Radius_link = BoolProperty(name='link var', default=False)
    Nsided_Radius_link = BoolProperty(name='link var', default=False)
    Splat_Radius_link = BoolProperty(name='link var', default=False)
    Helix_Radius_link = BoolProperty(name='link var', default=False)
    Cycloid_Radius_link = BoolProperty(name='link var', default=False)

    switch_direction = BoolProperty(name='Switch Curve direction', default=False)
    ...
    def draw(self, context):
        ...
        if self.ProfileType == 'Profile':
            ...
            box.prop(self, "Profile_Var_link",      toggle=True,    text="",    icon="LINKED")  
            ...
            box.prop(self, "Misc_Var_link",         toggle=True,    text="",    icon="LINKED")  
            ...
            box.prop(self, "Flower_Radius_link",    toggle=True,    text="",    icon="LINKED")  
            ...
            box.prop(self, "Star_Radius_link",      toggle=True,    text="",    icon="LINKED")  
            ...
            box.prop(self, "Arc_Radius_link",       toggle=True,    text="",    icon="LINKED")  
            ...
            box.prop(self, "Cogwheel_Radius_link",  toggle=True,    text="",    icon="LINKED")  
            ...
            #box.prop(self, "Nsided_Radius_link",    toggle=True,    text="",    icon="LINKED")  
            ...
            box.prop(self, "Splat_Radius_link",     toggle=True,    text="",    icon="LINKED")  
            ...
            box.prop(self, "Helix_Radius_link",     toggle=True,    text="",    icon="LINKED")  
            ...
            box.prop(self, "Cycloid_Radius_link",   toggle=True,    text="",    icon="LINKED")  
        ...
        box.prop(self, "switch_direction", toggle=True, text="Switch Direction", icon="FILE_REFRESH")  
    ...
    def execute(self, context):
        ...
        if self.Profile_Var_link:
            self.ProfileCurvevar2 = self.ProfileCurvevar1

        if self.Misc_Var_link:
            self.MiscCurvevar2 = self.MiscCurvevar1

        if self.Flower_Radius_link:
            self.outerRadius = self.innerRadius
            
        if self.Star_Radius_link:
            self.outerRadius = self.innerRadius
            
        if self.Arc_Radius_link:
            self.innerRadius = -self.outerRadius
            
        if self.Cogwheel_Radius_link:
            self.outerRadius = self.innerRadius
            
#        if self.Nsided_Radius_link:
#            self.var_2 = self.outerRadius
            
        if self.Splat_Radius_link:
            self.splatScale = self.outerRadius
            
        if self.Helix_Radius_link:
            self.helix_b = self.helix_a
            
        if self.Cycloid_Radius_link:
            self.cyclo_b = self.cyclo_a
