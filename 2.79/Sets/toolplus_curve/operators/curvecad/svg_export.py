...
class SVG_Export(bpy.types.Operator, ExportHelper):
    """ Units / Fills and Colors / Selection Only or All Visible  / Viewport Projection or Local Orthographic Projection / Absolute or Relative Coords /  SVG Path: Move To, Line To, Curve To, Close """
