...
def trigger_fast_navigate(trigger):
    scene = bpy.context.scene.display_props
...
class VIEW3D_TP_Visual_FastNavigate(Operator):
    bl_idname = "tp_ops.fast_navigate_operator"
    ...
    def modal(self, context, event):
        ...
        scene = context.scene.display_props
...
class VIEW3D_TP_Visual_FastNavigateStop(Operator):
    bl_idname = "tp_ops.fast_navigate_stop"
    bl_label = "Stop"
