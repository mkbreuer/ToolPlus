...
from toolplus_resurface.ui_menus.menu_relax   import (VIEW3D_TP_Relax_Menu)
...
def update_menu_relax(self, context):
    ...
    if context.user_preferences.addons[__package__].preferences.tab_menu_relax == 'menu':
    ...
    if context.user_preferences.addons[__package__].preferences.tab_menu_relax == 'off':
        pass
