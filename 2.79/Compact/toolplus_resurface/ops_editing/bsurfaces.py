...
bl_info = {
    "name": "Bsurfaces GPL (adjust for T+)",
    "author": "Eclectiel",
    "version": (1, 5, 1),
    "blender": (2, 76, 0),
...
#        layout = self.layout
#        scn = context.scene.tp_bsurfaces

#        col = layout.column(align=True)
#        row = layout.row()
#        row.separator()
#        col.operator("tp_gpencil.surfsk_add_surface", text="Add Surface")
#        col.operator("tp_gpencil.surfsk_edit_strokes", text="Edit Strokes")
...
class TP_GPENCIL_OT_SURFSK_add_surface(bpy.types.Operator):
    bl_idname = "tp_gpencil.surfsk_add_surface"
    ...
    def rectangular_surface(self):
        ...
        bpy.ops.curve.subdivide('INVOKE_REGION_WIN',
                                number_cuts=bpy.context.scene.tp_bsurfaces.SURFSK_precision)
        bpy.ops.object.editmode_toggle('INVOKE_REGION_WIN')
        ...
        curve_cuts = bpy.context.scene.tp_bsurfaces.SURFSK_precision * precision_multiplier
    ...
    def invoke(self, context, event):
        ...
        bsurfaces_props = bpy.context.scene.tp_bsurfaces
...
class TP_GPENCIL_OT_SURFSK_edit_strokes(bpy.types.Operator):
    bl_idname = "tp_gpencil.surfsk_edit_strokes"
...
# Properties
class tp_bsurfacesProps(PropertyGroup):
...
def register():
    ...
    bpy.types.Scene.tp_bsurfaces = PointerProperty(type=tp_bsurfacesProps)
