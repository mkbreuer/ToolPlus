...
# LOAD CACHE #
from toolplus_resurface.caches.cache      import  (settings_load)
from toolplus_resurface.caches.cache      import  (settings_write)
...
class VIEW3D_TP_BTube(bpy.types.Operator):
    ...
    def draw(self, context):
        ...
        row.prop(self, "sph_get_local", expand = True)        
