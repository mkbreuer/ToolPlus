...
bpy.types.Scene.tp_sym_default = bpy.props.BoolProperty(name="Use Symmtrize", description="use default symmtrize", default= False)
...
class VIEW3D_TP_Negativ_X_symcut(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        if bpy.context.scene.tp_sym_default == True:
