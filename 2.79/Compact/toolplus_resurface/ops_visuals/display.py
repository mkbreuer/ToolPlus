...
class VIEW3D_TP_Visual_Wire_All(bpy.types.Operator):
    """Wire on for all objects in the scene"""
    bl_idname = "tp_ops.edge_wire_all"
    bl_label = "Draw Wire (Scene)"
    bl_options = {'REGISTER', 'UNDO'}  
    ...
    all_edges = bpy.props.BoolProperty(name="Draw all Edges", default=True)  
...
class VIEW3D_TP_Visual_Wire_On(bpy.types.Operator):
    '''Wire on'''
    bl_idname = "tp_ops.edge_wire_on"
    bl_label = "Draw Wire (Selected)"
    bl_options = {'REGISTER', 'UNDO'}  
...
class VIEW3D_TP_Visual_Wire_Off(bpy.types.Operator):
    '''Wire off'''
    bl_idname = "tp_ops.edge_wire_off"
    bl_label = "Draw Wire off"
    bl_options = {'REGISTER', 'UNDO'}  
