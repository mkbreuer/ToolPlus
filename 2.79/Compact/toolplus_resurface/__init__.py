...
if "bpy" in locals():
    ...
    importlib.reload(origin_transform)
    ...
    # SYMDIM #
    importlib.reload(symcut)
    importlib.reload(symmods)
    ...
    # XTRAS #
    importlib.reload(endbow)        
    importlib.reload(loopgab)        
    importlib.reload(tubehole)     
    importlib.reload(cubesphere)     
    importlib.reload(sculptsphere)     
    ...
    # BOUNDING #
    from .ops_bounding import action    
    from .ops_bounding import boxes    
    from .ops_bounding import copy    
    from .ops_bounding import internal    
    ...
    # RENDER #
    from .ops_render import render_wireframe        
    ...
    # SYMDIM #
    from .ops_symdim import symcut
    from .ops_symdim import symmods
    ...
    # XTRAS #
    from .ops_xtras import endbow
    from .ops_xtras import loopgab
    from .ops_xtras import tubehole
    from .ops_xtras import cubesphere
    from .ops_xtras import sculptsphere
...
class TP_Panels_Preferences(AddonPreferences):
    ...
    tools_category = StringProperty(name = "TAB Category", description = "add name for a new category tab", default = '(WIP)', update = update_panel_position)
    ...
    tab_add_ui = bpy.props.BoolProperty(name="Primitives", description="enable / disable", default=True)
    tab_title_ui = bpy.props.BoolProperty(name="Title", description="enable / disable", default=True)
    tab_pivot_ui = bpy.props.BoolProperty(name="Pivots", description="enable / disable", default=True)
    tab_create_ui = bpy.props.BoolProperty(name="Insert", description="enable / disable", default=True)
    tab_align_ui = bpy.props.BoolProperty(name="Align", description="enable / disable", default=True)
    tab_boolean_ui = bpy.props.BoolProperty(name="Boolean", description="enable / disable", default=True)
    tab_copy_ui = bpy.props.BoolProperty(name="Copy", description="enable / disable", default=True)
    tab_convert_ui = bpy.props.BoolProperty(name="Convert", description="enable / disable", default=True)
    tab_origin_ui = bpy.props.BoolProperty(name="Origin", description="enable / disable", default=True)
    tab_snapshot_ui = bpy.props.BoolProperty(name="SnapShot", description="enable / disable", default=True)
    tab_edit_ui = bpy.props.BoolProperty(name="EditTools", description="enable / disable", default=True)
    tab_symdim_ui = bpy.props.BoolProperty(name="SymDim", description="enable / disable", default=True)
    tab_pencil_ui = bpy.props.BoolProperty(name="Pencil", description="enable / disable", default=True)
    tab_spacing_ui = bpy.props.BoolProperty(name="Spacing", description="enable / disable", default=True)
    tab_biped_ui = bpy.props.BoolProperty(name="Biped", description="enable / disable", default=True)
    tab_recoplanar_ui = bpy.props.BoolProperty(name="ReCoPlaner", description="enable / disable", default=True)
    tab_relax_ui = bpy.props.BoolProperty(name="Relaxing", description="enable / disable", default=True)
    tab_check_ui = bpy.props.BoolProperty(name="MeshCheck", description="enable / disable", default=True)
    tab_modifier_ui = bpy.props.BoolProperty(name="Modifier", description="enable / disable", default=True)
    tab_transform_ui = bpy.props.BoolProperty(name="Transform", description="enable / disable", default=True)
    tab_visual_ui = bpy.props.BoolProperty(name="Visual", description="enable / disable", default=True)
    tab_history_ui = bpy.props.BoolProperty(name="History", description="enable / disable", default=True)

    # CUTSOM #
    tab_custom_ui = bpy.props.BoolProperty(name="Custom", description="enable / disable", default=True)
    ...
    tab_brush_ui = bpy.props.BoolProperty(name="SculptBrush", description="enable / disable", default=True)
    tab_brush_quickset = bpy.props.BoolProperty(name="QuickBrush", description="enable / disable", default=True)
    tab_sculpt_edit = bpy.props.BoolProperty(name="SculptEdit", description="enable / disable", default=True)
    tab_sculpt_mask = bpy.props.BoolProperty(name="SculptMask", description="enable / disable", default=True)
    tab_modsculpt_ui = bpy.props.BoolProperty(name="Modifier", description="enable / disable", default=True)
    ...
    tab_custom_sculpt_ui = bpy.props.BoolProperty(name="Custom", description="enable / disable", default=True)
    ...
    # CURVETOOLS 2#
    tab_curve_ui = bpy.props.BoolProperty(name="Curves", description="enable / disable", default=True)


    #----------------------------


    # PREFERNCES MIRATOOLS #
    tab_miratools_ui = bpy.props.BoolProperty(name="MiraTools", description="enable / disable", default=True)
    tab_mirawrap_ui = bpy.props.BoolProperty(name="MiraWrap", description="enable / disable", default=True)
    tab_miraguide_ui = bpy.props.BoolProperty(name="MiraGuide", description="enable / disable", default=True)
    tab_mirastretch_ui = bpy.props.BoolProperty(name="MiraStretch", description="enable / disable", default=True)
    ...
    tab_surface_ui = bpy.props.BoolProperty(name="Surface Constraint", description="enable / disable", default=True)
...
class DropdownMiraToolProps(bpy.types.PropertyGroup):
    ...
    display_help = bpy.props.BoolProperty(name="Show Help", description="show help", default=False)
...
# EXPORT SELECTED #
def menu_func_export_selected(self, context):
...
def register():  
    ...
    # EXPORT SELECTED #
    bpy.types.INFO_MT_file_export.prepend(menu_func_export_selected)

    bpy.types.Scene.mychosenObject = bpy.props.StringProperty(name="")
...
def unregister():
    ...
    # EXPORT SELECTED #
    bpy.types.INFO_MT_file_export.remove(menu_func_export_selected)
