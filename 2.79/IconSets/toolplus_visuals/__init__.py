...
if "bpy" in locals():
    ...
    from .ops_material import material
    from .ops_material import matswitch
    from .ops_removes import delete   
    from .ops_removes import orphan
    ...
    from .ops_visuals import shading
...
class TP_Panels_Preferences(AddonPreferences):
    ...
    def draw(self, context):
        ...
        if self.prefs_tabs == 'url':
            row = layout.row()
            row.operator('wm.url_open', text = '', icon = 'IMAGE_COL').url = "https://plus.google.com/+MarvinKBreuer"
