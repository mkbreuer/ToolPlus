...
class VIEW3D_TP_Apply_Modifier_Array_OBM(bpy.types.Operator):
    """apply modifier array"""
    bl_idname = "tp_ops.apply_mods_array_obm"
...
class VIEW3D_TP_Apply_Modifier_Array_EDM(bpy.types.Operator):
    """apply modifier array"""
    bl_idname = "tp_ops.apply_mods_array_edm"
    bl_label = "Apply Array Modifier"
    bl_options = {'REGISTER', 'UNDO'}
...
class VIEW3D_TP_Remove_Modifier_Array_OBM(bpy.types.Operator):
    """remove modifier array"""
    bl_idname = "tp_ops.remove_mods_array_obm"
...
class VIEW3D_TP_Remove_Modifier_Array_EDM(bpy.types.Operator):
    """remove modifier array"""
    bl_idname = "tp_ops.remove_mods_array_edm"
    bl_label = "Remove Array Modifier"
    bl_options = {'REGISTER', 'UNDO'}
