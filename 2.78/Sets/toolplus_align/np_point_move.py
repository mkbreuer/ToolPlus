...
class NPPMGetContext(bpy.types.Operator):
    bl_idname = 'object.np_pm_get_context_np'
...
class NPPMGetSelection(bpy.types.Operator):
    bl_idname = 'object.np_pm_get_selection_np'
...
class NPPMGetMouseloc(bpy.types.Operator):
    bl_idname = 'object.np_pm_get_mouseloc_np'
    ...
    def invoke(self,context,event):
        ...
        #print('02_ReadMouseloc_INVOKED_FINISHED', ';', 'flag = ', NP020PM.flag)
...
class NPPMAddHelper(bpy.types.Operator):
    bl_idname = 'object.np_pm_add_helper_np'
    bl_label = 'NP PM Add Helper'
    bl_options = {'INTERNAL'}

    def execute(self, context):
        #print('03_AddHelpers_START', ';', 'flag = ', NP020PM.flag)  
        ...
        #print('03_AddHelpers_FINISHED', ';', 'flag = ', NP020PM.flag)
        return{'FINISHED'}
...
class NPPMPrepareContext(bpy.types.Operator):
    bl_idname = 'object.np_pm_prepare_context_np'
...
class NPPMRunTranslate(bpy.types.Operator):
    bl_idname = 'object.np_pm_run_translate_np'
...
def DRAW_RunTranslate(self, context):
    ...
    #print('04_DRAW_RunTranslate_START',';','flag = ', Storage.flag)
    flag = NP020PM.flag
...
class NPPMRestoreContext(bpy.types.Operator):
    bl_idname = "object.np_pm_restore_context_np"
